  ...
  switch (propertyId) {
    ...
    case 8:
      return (_TransactiontypeValueEnumMap[reader.readByteOrNull(offset)] ??
          TransactionType.investment) as P;
    default:
...
const _TransactiontypeValueEnumMap = {
  0: TransactionType.investment,
  1: TransactionType.additionalInvestment,
  2: TransactionType.income,
  3: TransactionType.dividend,
  4: TransactionType.expense,
  5: TransactionType.withdrawal,
  6: TransactionType.loan,
  7: TransactionType.loanRepayment,
  8: TransactionType.assetPurchase,
  9: TransactionType.assetSale,
  10: TransactionType.tax,
  11: TransactionType.other,
};
...
extension TransactionQueryWhereSort
  ...
  QueryBuilder<Transaction, Transaction, QAfterWhere> anyBusinessId() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQueryWhere
  ...
  QueryBuilder<Transaction, Transaction, QAfterWhereClause> businessIdEqualTo(
      int businessId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, Transaction, QAfterWhereClause>
      businessIdNotEqualTo(int businessId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Transaction, Transaction, QAfterWhereClause> businessIdLessThan(
    int businessId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Transaction, Transaction, QAfterWhereClause> businessIdBetween(
    int lowerBusinessId,
    int upperBusinessId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TransactionQuerySortBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByBusinessId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'businessId', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> sortByBusinessIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQuerySortThenBy
  ...
  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByBusinessId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'businessId', Sort.asc);
    });
  }

  QueryBuilder<Transaction, Transaction, QAfterSortBy> thenByBusinessIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'businessId', Sort.desc);
    });
  }
...
extension TransactionQueryWhereDistinct
  ...
  QueryBuilder<Transaction, Transaction, QDistinct> distinctByBusinessId() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionQueryProperty
  ...
  QueryBuilder<Transaction, int, QQueryOperations> businessIdProperty() {
    return QueryBuilder.apply(this, (query) {
